...
| `SectionHeader`                             | En-tête de section réutilisable (`h3` icône + titre + action). ⚠ Le fichier exporte aussi un `Section` à **0 consommateur** — code mort, à retirer.                                                                                                                   | 2      |
...
| `iconeFormat`                        | Icône selon le **format MIME**, pas le type métier. ⚠ Le fichier exporte aussi `PdfFileIcon`, à **0 consommateur** — code mort, à retirer.                                                                                                                                                            | 1\*     |
...
| `Section`, `PdfFileIcon`                                                                                                                                                          | **0 consommateur — code mort, à retirer**                                |
