...
function AppLayout() {
  ...
  // Mode automatique selon l'écran ET le type de pointeur :
  ...
  // Accessibilité SPA : déplacer le focus sur le contenu à chaque changement de
  // route réel (les lecteurs d'écran annoncent ainsi le nouvel écran). On compare
  // le pathname mémorisé plutôt qu'un drapeau booléen : robuste au double-montage
  // de StrictMode en dev (sinon le focus serait volé au chargement initial).
