...
/**
 * Menu contextuel (clic droit + appui long tactile) — brique shadcn calquée sur
 * `dropdown-menu.tsx`. Radix gère nativement le clic droit, l'appui long mobile,
 * le clavier (Shift+F10, flèches, Échap) et l'anti-débordement viewport.
 */
